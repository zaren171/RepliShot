...
#define BYTES_PER_PIXEL  (BITS_PER_PIXEL / 8)
    ...
    tesseract_ptr->SetImage((const unsigned char*)pixels, nWidth, nHeight, BYTES_PER_PIXEL, BYTES_PER_PIXEL * nWidth);

    std::unique_ptr<char[]> utf8_text_ptr(tesseract_ptr->GetUTF8Text());

    //OutputDebugStringA(utf8_text_ptr.get());

    std::string data(utf8_text_ptr.get());
    ...
    while (iss >> word) {
        if (word.find("Driver") != std::string::npos) {
            //OutputDebugStringA("Using Driver!\n");
            clubvalue = Driver;
            clubfound = TRUE;
            break;
        }
        else if (word.find("Wood") != std::string::npos) {
            //OutputDebugStringA("Using Wood!\n");
            if ((word.find("2") != std::string::npos) || (prev_word.find("3") != std::string::npos)) clubvalue = W2;
            if ((word.find("3") != std::string::npos) || (prev_word.find("3") != std::string::npos)) clubvalue = W3;
            if ((word.find("4") != std::string::npos) || (prev_word.find("4") != std::string::npos)) clubvalue = W4;
            if ((word.find("5") != std::string::npos) || (prev_word.find("5") != std::string::npos)) clubvalue = W5;
            clubfound = TRUE;
            break;
        }
        else if (word.find("Hybrid") != std::string::npos) {
            //OutputDebugStringA("Using Hybrid!\n");
            if ((word.find("2") != std::string::npos) || (prev_word.find("3") != std::string::npos)) clubvalue = HY2;
            if ((word.find("3") != std::string::npos) || (prev_word.find("3") != std::string::npos)) clubvalue = HY3;
            if ((word.find("4") != std::string::npos) || (prev_word.find("4") != std::string::npos)) clubvalue = HY4;
            if ((word.find("5") != std::string::npos) || (prev_word.find("5") != std::string::npos)) clubvalue = HY5;
            clubfound = TRUE;
            break;
        }
        else if (word.find("Iron") != std::string::npos) {
            //OutputDebugStringA("Using Iron!\n");
            if ((word.find("3") != std::string::npos) || (prev_word.find("3") != std::string::npos)) clubvalue = I3;
            if ((word.find("4") != std::string::npos) || (prev_word.find("4") != std::string::npos)) clubvalue = I4;
            if ((word.find("5") != std::string::npos) || (prev_word.find("5") != std::string::npos)) clubvalue = I5;
            if ((word.find("6") != std::string::npos) || (prev_word.find("6") != std::string::npos)) clubvalue = I6;
            if ((word.find("7") != std::string::npos) || (prev_word.find("7") != std::string::npos)) clubvalue = I7;
            if ((word.find("8") != std::string::npos) || (prev_word.find("8") != std::string::npos)) clubvalue = I8;
            if ((word.find("9") != std::string::npos) || (prev_word.find("9") != std::string::npos)) clubvalue = I9;
            clubfound = TRUE;
            break;
        }
        else if (word.find("Wedge") != std::string::npos) {
            //OutputDebugStringA("Using Wedge!\n");
            if ((word.find("Gap") != std::string::npos) || (prev_word.find("Gap") != std::string::npos)) clubvalue = GW;
            if ((word.find("Lob") != std::string::npos) || (prev_word.find("Lob") != std::string::npos)) clubvalue = LW;
            if ((word.find("Sand") != std::string::npos) || (prev_word.find("Sand") != std::string::npos)) clubvalue = SW;
            if ((word.find("Pitching") != std::string::npos) || (prev_word.find("Pitching") != std::string::npos)) clubvalue = PW;
            clubfound = TRUE;
            break;
        }
        else if (word.find("Lob") != std::string::npos) {
            //OutputDebugStringA("Using Wedge!\n");
            clubvalue = LW;
            clubfound = TRUE;
            break;
        }
        else if (word.find("Gap") != std::string::npos) {
            //OutputDebugStringA("Using Wedge!\n");
            clubvalue = GW;
            clubfound = TRUE;
            break;
        }
        else if (word.find("Pitching") != std::string::npos) {
            //OutputDebugStringA("Using Wedge!\n");
            clubvalue = PW;
            clubfound = TRUE;
            break;
        }
        else if (word.find("Sand") != std::string::npos) {
            //OutputDebugStringA("Using Wedge!\n");
            clubvalue = SW;
            clubfound = TRUE;
            break;
        }
        else if (word.find("Putter") != std::string::npos) {
            //OutputDebugStringA("Using Putter!\n");
            clubvalue = Putter;
            clubfound = TRUE;
            break;
        }
    ...
    //if(!clubfound) OutputDebugStringA(utf8_text_ptr.get());
    ...
    _In_ int       nCmdShow)
{
    ...
    HRSRC src = FindResource(NULL, MAKEINTRESOURCE(IDR_BINARY1), RT_RCDATA);
